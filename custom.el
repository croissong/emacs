(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (xtest window-purpose which-key wgrep-ag web-mode undo-tree togetherly swiper ssh-agency sql-indent spaceline soft-stone-theme smex smartparens scss-mode request-deferred req-package rainbow-mode racer projectile php-mode org-plus-contrib neotree navi-mode nameless multiple-cursors markdown-mode magit-gh-pulls json-mode js2-mode hungry-delete htmlize google-translate git-wip-timemachine git-timemachine flycheck-rust flx-ido floobits expand-region evil-nerd-commenter esqlite elpy ein dumb-jump drag-stuff dired+ company-web company-racer coffee-mode centered-window-mode cargo buffer-move bitly avy-menu auto-package-update auctex alchemist aggressive-indent ag adaptive-wrap))))
(custom-set-faces
